...
//number of pairs that are formed and answer[1] is the number of leftover integers in 
...
//Output: [3,1]
//Explanation:
//Form a pair with nums[0] and nums[3] and remove them from nums. Now, nums = [3
//,2,3,2,2].
//Form a pair with nums[0] and nums[2] and remove them from nums. Now, nums = [2
//,2,2].
...
// 
//
// Related Topics Array Hash Table Counting 👍 173 👎 5
